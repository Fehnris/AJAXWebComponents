...
Array:          dataArray         null                          DEFAULT,Array             used to supply data as Array (used with
                                                                                          dataSource 'ARRAY' MODE
Object:         AMCREF            null                          DEFAULT,Object            AMCREF (AJAXManagerClientReference) points to
                                                                                          instance of AJAXManagerClient.  Used with
                                                                                          dataSource 'AJAX' MODE
Object.Method   AMCAPI            null                          DEFAULT,Object.Method     AMCAPI (AJAXManagerClient)(API) points to 
                                                                                          method of instance of AJAXManagerClient
                                                                                          that accepts new AJAX requests from
                                                                                          components.  Used with dataSource 'AJAX' MODE
Integer:        searchDelay       350                           DEFAULT,0-65535           Creates a delay between key presses.  Most
                                                                                          useful when used in 'AJAX' MODE.  Having a 
                                                                                          delay means that every key press isn't sent as
                                                                                          a new AJAX request.  If set to 0 every key
                                                                                          press will cause a new AJAX request to be
                                                                                          sent.  350 (0.35 of a second) recommended.
String:         AJAXURL           ""                            DEFAULT,"<URLForAJAX>"    When using dataSource 'AJAX' MODE this is
                                                                                          where the file that processes the AJAX
                                                                                          request can be specified.
String:         AJAXFetchMethod   "GET"                         DEFAULT,"POST"            When using dataSource 'AJAX' MODE here is
                                                                                          where the request mode type can be specified.
